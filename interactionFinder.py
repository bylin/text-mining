...
def parseArgs():
	...
	parser.add_argument('-p', '--extractionData', type=argparse.FileType('r'), default='/cluster/home/blin/hive/mining/text_filter/extractionData/extractionData.pkl', help='Pickled file with relation and author dictionaries')
